...
Great laptop; everything except the fingerprint reader basically works out the box. One noteworthy kernel parameter required to boot system: pci=nommconf 
...
6) Machine was $1350 from Costco: i7-8565U, 16GB ram, 
