...
Great laptop, light as hell with a glorious 17inch screen; no frills, lots of good decisions and everything except the fingerprint reader works out the box. One noteworthy kernel parameter required to boot the system (with a pevious EFI image): pci=nommconf 
